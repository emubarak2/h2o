...
public class DataSetController {
    ...
    public String searchAllDataSet(@RequestParam("search_query") String searchQuery) {
        return JsonUtility.convertObjectToJson(dataSetService.getSearchResults(searchQuery));
    }
    ...
    public SearchResultsWrapper searchSpecificDataSet(@PathVariable("contentId") String contentId, @RequestParam("search_query") String searchText) {
